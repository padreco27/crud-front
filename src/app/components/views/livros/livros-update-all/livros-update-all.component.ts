...
@Component({
  selector: 'app-livros-update-all',
  templateUrl: './livros-update-all.component.html',
  styleUrls: ['./livros-update-all.component.css']
})
export class LivrosUpdateAllComponent implements OnInit {
